# Generated by Django 5.2.3 on 2025-08-12 08:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(verbose_name='حذف شده/نشده')),
                ('category', models.ManyToManyField(related_name='products_categories', to='product_module.productcategory', verbose_name='دسته بندی ها')),
            ],
            options={
                'verbose_name': 'محصول ',
